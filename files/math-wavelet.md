...
Wavelet逆変換が出来るのは、正規直交規定という条件があるのですが、
...
### MorletWaveletとは
1980年台に、GaborWabeletが正規直交じゃない事を憂いた人たちが手を加え、正規直交にしてくれました。
...
括弧の中に引き算が入りました。正規直交のMorlet Waveletです。[^morlet]
**この魔法の引き算によってMorletWaveletは正規直交基底になる**のです。
