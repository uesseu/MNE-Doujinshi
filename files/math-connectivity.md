...
ちなみに、以下の方法は基本、低周波じゃないと無理です。
γ波なんかを処理しようとするのは無謀なのであります。
...
## PLVやCoherenceの欠点の克服
いくつか方法があります。大きく分けて2つ、またはその組み合わせです。
...
CurrentSourceDensityという方法があるらしいです。
こっちはソースベース解析ほどバリバリに推定するわけではない感じですが、
PLVの弱点を補う方法ですね。残念ながらMNEpythonには未実装です。
ていうか、僕はこの方法を知らないのです。
