...
Wが、例えばXの振幅の予測値ならば「Xの大きすぎる所を小さく」になるわけです。
...
というか、実際の所、$\lambda I$ってどんだけノイズが入っているかであるべきです。
そして、そのノイズはチャンネルによって違います。
だから、脳内のノイズの分散共分散行列をCとして、$\lambda I$の代わりとしてあげます。
…ノイズと言いましたが「背景」と言ったほうがわかりやすいかも知れません。
数学得意な人は「重み付き最小ノルム解」と言います。
数学得意な人は一々強そうな名前言いますよね…。
